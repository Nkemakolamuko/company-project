  ...
  return (
    <section className="relative py-10 bg-[#043A53]">
      <div className="grid grid-cols-2 grid-rows-2 text-center text-gray-700 px-4 md:px-10">
        <div className="p-12 flex items-center justify-center text-start hover:z-50 bg-white hover:bg-white/80 transition-all duration-300 border border-gray-100">
          <p>
